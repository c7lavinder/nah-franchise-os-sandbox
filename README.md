...
12. `docs/lint-debt-snapshot.md` — current lint warning categories
13. `docs/test-coverage-map.md` — current cleanup-critical tests
14. `docs/runbook.md` — when things break
