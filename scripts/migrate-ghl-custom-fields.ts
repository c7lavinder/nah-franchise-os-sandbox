...
const FIELD_MAP: Record<string, string> = {
  ...
  r3D9pkMOmAfYQgfgOBHf: "CountiesInterestedIn",
  RQjpIT2LXIMiC3pbCui5: "nda_status",
  bfnObe8LBN2NhlP2YIgg: "framing_call_logged",
  ptn3LorDS6ThhnsjQL6k: "BriefWorkHistory",
  AbniyMfCcg0mVVJHgNnn: "NonRetirementCapitalAvailable",
  CBAUgTKdryFXtmG8wL9u: "investment_timeline",
  QvCGhfBPZkonrr0s7yqs: "WhatInterestsInOpportunity",
  ...
  // Lead source
  utPxX4VuZLQpmuQHfguU: "LeadSource",
  ...
  // Partner/ecosystem
  srQewMbTAaO3dEw06MVW: "PartnerName",
  WNNbbZVZRxnT3wt5JAui: "PartnerEmail",
  hdMYUybphMbu22L7273T: "PartnerPhone",
