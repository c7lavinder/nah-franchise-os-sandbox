...
export const AGENT_CATEGORIES: AgentCategory[] = [
  {
    ...
    summary: "Create inbound demand, build outbound lists, and keep paid acquisition accountable.",
  },
  {
    key: "lead-management",
...
export const AGENT_REGISTRY: AgentRegistryEntry[] = [
  ...
  },
  {
    ...
    label: "Inbound Lead Gen Manager",
    roleTitle: "Paid Acquisition Audit Agent",
    category: "marketing",
    status: "active",
    trigger: "Manual channel audit now, future ad-platform sync and weekly lead-gen review",
    description: "Audits Facebook and Google ad performance, inbound lead quality, and missed optimization opportunities.",
    mission: "Keep inbound lead generation accountable by showing what ads are producing, what is wasting spend, and what to test next.",
    uses: ["Audits paid ad performance", "Compares inbound lead quality", "Recommends next tests"],
    howItWorks: [
      "Reads ad, source, and inbound lead performance.",
      "Compares volume, quality, cost, and pipeline movement by channel.",
      "Finds campaigns, audiences, or territories that need attention.",
      "Recommends creative, targeting, landing page, or budget tests for human review.",
    ],
    dataSources: ["Facebook Ads", "Google Ads", "Marketing V1", "Contacts attribution", "Scout scores"],
    guardrails: ["No fake spend data", "Ad-platform access required", "Recommendations need human approval"],
    canDo: ["Explain ad performance", "Find inbound quality gaps", "Help plan tests"],
  ...
  },
  {
    ...
    label: "Marketing Content Builder",
    roleTitle: "Nurture and Ad Content Agent",
    category: "marketing",
    status: "planned",
    trigger: "Future content planning workspace, campaign briefs, and approved launch checklist",
    description: "Creates high-performing nurturing content and inbound lead content for Facebook and Google campaigns.",
    mission: "Give the team a steady engine for useful nurture content, ad angles, and lead-converting campaign assets.",
    uses: ["Drafts nurture content", "Creates ad angles", "Builds inbound lead content packages"],
    howItWorks: [
      "Reads lead source performance, audience fit, and campaign goals.",
      "Suggests content themes for nurture, retargeting, and inbound acquisition.",
      "Drafts ad copy, email content, landing page sections, and follow-up sequences.",
      "Routes assets through approval before anything goes live.",
    ],
    dataSources: ["Marketing V1", "Lead sources", "Campaign history", "Brand messaging", "Ideal franchisee profile"],
    guardrails: ["No auto-launching", "Spend and sends require approval", "Uses approved brand language"],
    canDo: ["Draft nurture campaigns", "Create ad content", "Recommend creative tests"],
  ...
  {
    name: "outbound-lead-generator",
    label: "Outbound Lead Generator",
    roleTitle: "Outbound Prospecting Agent",
    category: "marketing",
    status: "planned",
    trigger: "Future ICP list build, enrichment, and approved nurture enrollment",
    description: "Builds email lists of people who fit the franchisee mold and prepares them for nurturing campaigns.",
    mission: "Create a qualified outbound top-of-funnel without turning outreach into random list scraping.",
    uses: ["Builds ICP-fit lead lists", "Enriches prospect records", "Queues nurture campaign enrollment"],
    howItWorks: [
      "Reads the ideal franchisee profile and target market rules.",
      "Finds people and companies that appear to fit the mold.",
      "Enriches records with source links, confidence, and segmentation.",
      "Queues qualified prospects for approved nurture campaigns.",
    ],
    dataSources: ["Ideal franchisee profile", "Approved prospect sources", "Contacts", "Nurture campaigns"],
    guardrails: ["No auto-sending", "Respects suppression rules", "Human approval required before enrollment"],
    canDo: ["Build outbound lists", "Enrich lead records", "Recommend nurture segments"],
    cannotDo: ["Scrape disallowed sources", "Send outreach alone", "Ignore opt-out or suppression rules"],
    costPerRunEstimate: "$0.002/run est.",
    trustLevel: "approval-required",
    supportsManualRun: false,
    supportsConversation: true,
    portrait: {
      ...
      jacket: "bg-emerald-800",
      expression: "Prospecting",
    },
  },
  {
