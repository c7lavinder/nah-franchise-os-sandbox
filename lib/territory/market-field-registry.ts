...
export const MARKET_FIELDS: MarketField[] = [
  ...
  {
    name: "territory_value_est",
    label: "Territory Value Estimate",
    category: "territory_overview",
    dataType: "currency",
    populationSource: "mastersuite",
    autoPopulate: false,
  },
  {
    name: "counties_included",
  ...
  // ═══════════════════════════════════════
  {
    name: "population_growth_1yr",
    label: "Population Growth (1yr)",
    category: "population_trends",
    dataType: "percentage",
    populationSource: "census",
    autoPopulate: true,
  },
  {
    name: "population_growth_5yr",
  ...
  {
    name: "net_migration_annual",
    label: "Net Migration (Annual)",
    category: "population_trends",
    dataType: "number",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "pct_built_before_1970",
    label: "% Built Before 1970",
    category: "housing",
    dataType: "percentage",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "housing_permits_annual",
    label: "New Housing Permits (Annual)",
    category: "housing",
    dataType: "number",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "pct_cost_burdened",
    label: "% Cost-Burdened (>30% income)",
    category: "housing",
    dataType: "percentage",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "mortgage_rate_avg",
    label: "Avg Mortgage Rate (Local)",
    category: "housing",
    dataType: "percentage",
    populationSource: "zillow",
    autoPopulate: false,
  ...
  {
    name: "pct_homes_with_mortgage",
    label: "% Homes with Mortgage",
    category: "housing",
    dataType: "percentage",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "median_monthly_housing_cost",
  ...
  {
    name: "yoy_home_appreciation",
    label: "YoY Home Value Appreciation",
    category: "real_estate_market",
    dataType: "percentage",
    populationSource: "zillow",
    autoPopulate: true,
  ...
  {
    name: "home_appreciation_5yr",
    label: "5-Year Home Appreciation",
    category: "real_estate_market",
    dataType: "percentage",
    populationSource: "zillow",
    autoPopulate: true,
  ...
  {
    name: "foreclosure_rate",
    label: "Foreclosure Rate",
    category: "real_estate_market",
    dataType: "percentage",
    populationSource: "attom",
    autoPopulate: true,
  },
  {
    name: "pre_foreclosure_count",
    label: "Pre-Foreclosure Count",
    category: "real_estate_market",
    dataType: "number",
    populationSource: "attom",
    autoPopulate: true,
  ...
  {
    name: "avg_seller_concession",
    label: "Avg Seller Concession",
    category: "real_estate_market",
    dataType: "percentage",
  ...
  {
    name: "pct_price_reductions",
    label: "% Listings with Price Reductions",
    category: "real_estate_market",
    dataType: "percentage",
    populationSource: "zillow",
    autoPopulate: true,
  ...
  {
    name: "new_listings_monthly",
    label: "New Listings (Monthly Avg)",
    category: "real_estate_market",
    dataType: "number",
    populationSource: "zillow",
    autoPopulate: true,
  ...
  {
    name: "flip_rate",
    label: "Flip Rate (% of sales)",
    category: "flip_market",
    dataType: "percentage",
    populationSource: "attom",
    autoPopulate: true,
  },
  {
    name: "flip_volume_annual",
    label: "Annual Flip Volume",
    category: "flip_market",
    dataType: "number",
    populationSource: "attom",
    autoPopulate: true,
  ...
  {
    name: "avg_flip_profit",
    label: "Avg Gross Flip Profit",
    category: "flip_market",
    dataType: "currency",
    populationSource: "attom",
    autoPopulate: true,
  ...
  },
  {
    ...
    label: "Avg Purchase Price (Flips)",
    category: "flip_market",
    dataType: "currency",
    populationSource: "attom",
    autoPopulate: true,
  ...
  {
    name: "avg_purchase_discount",
    label: "Avg Purchase Discount (%)",
    category: "flip_market",
    dataType: "percentage",
    populationSource: "attom",
    autoPopulate: true,
  ...
  {
    name: "best_flip_zip_codes",
    label: "Best Zip Codes for Flips",
    category: "flip_market",
    dataType: "tags",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "best_price_range",
    label: "Best Price Range for Flips",
    category: "flip_market",
    dataType: "text",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "flip_friendly_lenders",
    label: "Flip-Friendly Lenders (Local)",
    category: "flip_market",
    dataType: "tags",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "wholesale_deal_flow",
    label: "Wholesale Deal Flow (Monthly)",
    category: "flip_market",
    dataType: "number",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "avg_days_to_sell_flip",
    label: "Avg Days to Sell (Flipped)",
    category: "flip_market",
    dataType: "number",
    populationSource: "attom",
    autoPopulate: true,
  ...
  // ═══════════════════════════════════════
  {
    ...
    category: "economy_employment",
    dataType: "percentage",
    populationSource: "bls",
    autoPopulate: true,
  },
  {
    name: "labor_force_size",
  ...
  {
    name: "job_growth_rate_1yr",
    label: "Job Growth Rate (1yr)",
    category: "economy_employment",
    dataType: "percentage",
    populationSource: "bls",
    autoPopulate: true,
  ...
  {
    name: "job_growth_rate_5yr",
    label: "Job Growth Rate (5yr)",
    category: "economy_employment",
    dataType: "percentage",
    populationSource: "bls",
    autoPopulate: true,
  ...
  {
    name: "new_business_formations",
    label: "New Business Formations (Annual)",
    category: "economy_employment",
    dataType: "number",
    populationSource: "census",
    autoPopulate: true,
  ...
  {
    name: "avg_labor_rate_hr",
    label: "Avg Labor Rate ($/hr)",
    category: "construction",
    dataType: "currency",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "avg_material_cost_sqft",
    label: "Avg Material Cost ($/sq ft)",
    category: "construction",
    dataType: "currency",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "avg_rehab_cost_sqft",
    label: "Avg Rehab Cost ($/sq ft)",
    category: "construction",
    dataType: "currency",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "permit_timeline_days",
    label: "Permit Timeline (Days)",
    category: "construction",
    dataType: "number",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "permit_cost_avg",
    label: "Avg Permit Cost",
    category: "construction",
    dataType: "currency",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "hoa_prevalence",
    label: "HOA Prevalence",
    category: "construction",
    dataType: "select",
    populationSource: "scout",
    autoPopulate: false,
    options: ["High", "Medium", "Low", "Rare"],
  },
  {
    name: "renovation_restrictions",
    label: "Renovation Restrictions",
    category: "construction",
    dataType: "text",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "licensed_contractors_count",
    label: "Licensed Contractors (Area)",
    category: "construction",
    dataType: "number",
    populationSource: "manual",
    autoPopulate: false,
  },
  {
    ...
    label: "Construction Season",
    category: "construction",
    dataType: "select",
    populationSource: "scout",
    autoPopulate: false,
    options: ["Year-round", "Mar-Nov", "Apr-Oct", "May-Sep"],
  },
  ...
  // ═══════════════════════════════════════
  {
    name: "active_flippers_count",
    label: "Active Flippers (Estimated)",
  ...
  {
    name: "ibuyer_presence",
    label: "iBuyer Presence",
    category: "competition",
    dataType: "multi_select",
    populationSource: "manual",
    autoPopulate: false,
    options: ["Opendoor", "Offerpad", "Zillow Offers", "RedfinNow", "None"],
  },
  {
    name: "wholesaler_activity",
    label: "Wholesaler Activity",
    category: "competition",
    dataType: "select",
    populationSource: "scout",
    autoPopulate: false,
  ...
  {
    name: "investor_saturation",
    label: "Investor Saturation",
    category: "competition",
    dataType: "select",
    populationSource: "scout",
    autoPopulate: false,
    options: ["Saturated", "Moderate", "Underserved"],
  },
  {
  ...
  {
    name: "buy_box_overlap",
    label: "Buy Box Overlap",
    category: "competition",
    dataType: "text",
    populationSource: "scout",
    autoPopulate: false,
    help: "Which competitors target same properties",
  },
  {
    name: "competitive_advantage",
    label: "NAH Competitive Advantage",
    category: "competition",
    dataType: "text",
    populationSource: "scout",
    autoPopulate: false,
